  ...
  return (
    <div className="h-[590px] w-full bg-[url('https://dhgf5mcbrms62.cloudfront.net/87104005/cover-JsJj8T/028dSS4-2000x2000.webp')] bg-cover bg-center">
      <div className="flex text-center items-center flex-col pt-10 lg:pt-32">
        <h1 className="text-4xl text-white lg:text-[50px] font-bold pb-10 lg:pb-5">HIGH QUALITY MOCKUP</h1>
        <p className="text-lg text-white">Speed up your Work with this PSD Mockup! </p>
        <p className="text-base lg:text-lg lg:w-[900px] text-white">
        ...
        <Link href={'/products'}>
        <button className="bg-blue-400 px-5 py-2 rounded-md mt-14 text-white">Shop Now</button>
        </Link>
